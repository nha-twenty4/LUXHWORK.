      ...
      <section className="hero" id="hero">
        ...
        <div className="hero-copy">
          ...
          <div className="hero-bottom">
            <div className="hero-bottom-copy"><p>Interior consultancy, design, fit-out and aftercare<span className="hero-description-break"><br /></span> for offices, retail, hospitality and F&amp;B.</p><div className="hero-mobile-meta"><a href="#about">Scroll to explore <ArrowDownRight size={14} /></a><span>SINCE 2019</span></div></div>
...
function AboutVisualHero({ compact = false }: { compact?: boolean }) {
  return <section className={`about-visual-hero${compact ? " about-visual-hero-compact" : ""}`}>
    <SafeImage src="/about-image-upscaled.png" alt="LUXHWORK commercial interior project" />
