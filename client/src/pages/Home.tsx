  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-nap">
        <div><span className="footer-kicker">Studio</span><strong style={{ fontFamily: "MOMCAKE", fontSize: "16px" }}>LUXHWORK</strong><a className="footer-address" href="https://www.google.com/maps/search/?api=1&query=LUXHWORK%2C%20Preah%20Ang%20Yukanthor%20Street%2019%2C%20Phnom%20Penh%2C%20Cambodia" target="_blank" rel="noreferrer">#MF, No. 112G E0, Preah Ang Yukanthor Street (19), Sangkat Phsar Kandal 2, Khan Daun Penh, Phnom Penh 12205, Cambodia <ArrowUpRight size={12} /></a></div>
